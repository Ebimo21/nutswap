...
export default function Settings ({ stopFn, closeSettings}){
    ...
    return(
      <div onClick={stopFn} className="z-20 text-white fixed bg-black rounded-tl-xl rounded-tr-xl py-6 px-6 left-0  bottom-0">
        ...
        <div className="mt-5 flex flex-wrap items-center justify-between gap-x-2 gap-y-4">
            ...
            <SlippageBadge fn={handleSetSlippage} style={` ${slippage == "49%" ? "bg-white text-black": ""} w-full bg-transparent border border-solid border-[#ffff6c] text-[#ffff6c] text-xl py-4`} amount="49%" />
        </div>
